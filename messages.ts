...
export const messages = pgTable(
  ...
  (table) => ({
    ...
    /** FK for self-referencing parent_id */
    /** NOTE: Self-reference FK is not expressible here with onDelete behavior;
     *  it should be added via raw SQL migration for SET NULL on cascade. */
  }),
);
